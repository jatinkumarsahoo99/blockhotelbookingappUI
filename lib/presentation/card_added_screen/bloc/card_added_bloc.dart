import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:jatin_kumar_s_application3/presentation/card_added_screen/models/card_added_model.dart';part 'card_added_event.dart';part 'card_added_state.dart';/// A bloc that manages the state of a CardAdded according to the event that is dispatched to it.
